// src/functions/Scheduler/Transformers/html-to-plaintext-transformer.ts

import { IngestionData } from '../interfaces'; // Adjust path if necessary
...
export  {htmlToPlaintextTransformer};
